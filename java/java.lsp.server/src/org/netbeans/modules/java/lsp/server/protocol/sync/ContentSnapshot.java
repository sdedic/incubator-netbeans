...
/**
 * Contains a snapshot of a text documents and line index. Positions of line starts
 * is computed during creation. The class can convert offsets to LSP Positions and
 * vice versa.
 * 
 * @author sdedic
 */
