...
public class MavenReloadImplementation implements ProjectReloadImplementation {
    ...
    /**
     * <li>BROKEN - the parent artifact or other critical part is not found, which breaks most of the model
     * <li>LOADED - some faked artifacts are reported
     * <li>RESOLVED - no faked artifacts, the project model should be complete incl. artifacts
     * <li>CONSISTENT - RESOLVED + no 
     * @return 
     */

    @Override
    public Quality getProjectData() {
        ...
        return obsolete ? Quality.RESOLVED : Quality.CONSISTENT;
    }
    ...
    public Set<FileObject> findProjectFiles(boolean forReload) {
        ...
        while ((a = toProcess.poll()) != null) {
            ...
            if (pom != null) {
                ...
                Set<FileObject> fos = ProjectReload.findProjectFiles(parentOwner, false);
                for (FileObject f : fos) {
    ...
    @NbBundle.Messages({
        "# {0} - number of files",
        "ERR_UnsavedFiles={0} project files are not saved"
    })
    ...
    private void reloadProject(ProjectReload.ProjectStateRequest request) {
    }
    ...
    class Reloader {
        ...
        public Reloader(Set<FileObject> files, ProjectReload.ProjectStateRequest request) {
            this.files = files;
    ...
    @Override
    public CompletionStage<Project> withReadyState(ProjectReload.ProjectStateRequest request) throws ProjectOperationException {
        ...
        Set<FileObject> fos = checkMemoryModified(!request.isSaveModifications());
