...
public class CompartmentNode extends CloudNode {
    ...
    @NodeProvider.Registration(path = "Oracle/Compartment")
     ...
     */
    @ChildrenProvider.Registration(parentPath = {"Oracle/Tenancy", "Oracle/Compartment"} ) 
        ...
        return parent -> {
            ...
            do {
                ...
                response.getItems().stream()
                        .map(c -> new CompartmentItem(OCID.of(c.getId(), "Oracle/Compartment"), c.getName())) // NOI18N
