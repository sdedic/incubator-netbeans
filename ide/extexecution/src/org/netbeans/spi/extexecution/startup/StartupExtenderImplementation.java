 ...
 * should be passed as a whole by API users and the API user decides on quoting appropriate for the
 * intended purpose (i.e. to construct a command line). 
 * 
 * @author Petr Hejl
 * @since 1.30
 * @see StartupExtender
...
public interface StartupExtenderImplementation {
    ...
    public @interface Registration {
         ...
         * @since 1.62
         */
        boolean argumentsEscaped() default true;
    }
}
