...
public class PathFinderVisitor extends ClassCodeVisitorSupport {
    ...
    private boolean addToPath(ASTNode node) {
        ...
        // normal behaviour for non-expressions and declaration expressions
        ...
        // the method expression does use parenthesis, then any trailing thing will
        ...
        return isInside(node, line, column, true, false);
    }
